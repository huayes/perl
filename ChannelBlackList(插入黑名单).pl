...
#select Phone from ChannelBlackList_2012-01-20 where Phone='$phone';

#insert into ChannelBlackList_2012-01-20 (Phone,UpdateTime) values ('$phone',now());
open( FILE, "/home/liangsh/testfile" ) or die $!;
while (<FILE>) {
    chomp;
