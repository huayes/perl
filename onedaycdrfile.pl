  ...
  #print "$n\n"; 
        #}
          opendir( AA, $cdrfilepath );
           my @cdrfilearry = grep { /.+GW00[1-5].+$day$hours.+/ } readdir(AA);
           #print "@cdrfilearry\n";
           closedir(AA);
            #print "@cdrfilearry";
